 ...
 * @author IFMG
 */
public class Tela_RemoveIng extends javax.swing.JFrame {

    /**
     * Creates new form Tela_AddIng
     */
    public Tela_RemoveIng() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jList_ing.setModel(new javax.swing.AbstractListModel<String>() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_RemoveIng.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_RemoveIng().setVisible(true);
            }
        });
    }
